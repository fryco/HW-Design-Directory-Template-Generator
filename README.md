...
Directory structure is described in `DirectoryTemplate.txt` or `DirectoryTemplateBasic.txt`. (Basic template is suggested for more experianced user, who know what each location should contains. In this case, readme files will be not generated.) You can use tree available definitions:
